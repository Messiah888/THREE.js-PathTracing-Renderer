...
THREE.FBXLoader = ( function () {
	...
	GeometryParser.prototype = {
		...
		genGeometry: function ( geoNode, skeleton, morphTarget, preTransform ) {
			...
			geo.setIndex(new THREE.BufferAttribute(  new Uint8Array(buffers.indexes), 1 )); 
		...
		genBuffers: function ( geoInfo ) {
			...
			geoInfo.vertexIndices.forEach( function ( vertexIndex, polygonVertexIndex ) {
				...
				if ( endOfFace ) {
					...
					self.genFace( buffers, geoInfo, facePositionIndexes, materialIndex, faceNormals, faceColors, faceUVs, faceWeights, faceWeightIndices, faceLength, indexes );
	...
	/*			if(!previousVertex[vertex]){
					previousVertex.push(vertex);
				}
				indexes.push(previousVertex.indexOf(vertex));*/
			} );

			var geometry = new THREE.BufferGeometry();
			//geometry.addAttribute( 'position', new THREE.BufferAttribute( positions, 3 ) );
			//geometry.setIndex( new THREE.BufferAttribute(  new Uint8Array(indexes), 1 )); 
			return geometry;
